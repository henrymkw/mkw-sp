...
asset_in_files = {
    ...
    os.path.join('Scene', 'UI', 'GlobeSP.arc.lzma'): [
        ...
        os.path.join('button', 'timg', 'tt_pattern_chek_alpha_nasi_32x32.tpl'),
        os.path.join('button', 'timg', 'tt_pattern_chek_bokashi_32x32.tpl'),
        ...
        os.path.join('button', 'anim', 'common_w083_earth_chat_message_select_noscale.brlan.json5'),
        os.path.join('button', 'anim', 'common_w083_earth_chat_message_free_noscale.brlan.json5'),
        os.path.join('button', 'anim', 'common_w083_earth_chat_message_select_to_free_noscale.brlan.json5'),
        os.path.join('button', 'anim', 'common_w083_earth_chat_message_free_to_select_noscale.brlan.json5'),
        ...
        os.path.join('button', 'blyt', 'ArrowUpDown.brlyt.json5'),
        os.path.join('button', 'ctrl', 'ArrowUpDown.brctr.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_active_off.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_active_off_to_on.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_active_on.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_fade_in.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_fade_in_after.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_fade_in_before.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_fade_out.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_free_to_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_fuchi_check_loop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_select_to_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_text_light_01_ok.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_text_light_01_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_text_light_02_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w024_rule_icon_text_light_02_stop.brlan.json5'),
        os.path.join('button', 'ctrl', 'CategorySwapButton.brctr.json5'),
        os.path.join('button', 'blyt', 'common_w097_license_screen_menu.brlyt.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_fade_in.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_fade_in_after.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_fade_in_before.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_fade_out.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_free_to_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_fuchi_check_loop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_select_to_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_01_ok.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_01_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_02_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_02_stop.brlan.json5'),
    ...
    os.path.join('Scene', 'UI', 'MenuMultiSP.arc.lzma'): [
        ...
        os.path.join('bg', 'ctrl', 'MenuObiTopNoCurve.brctr.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_select_noloop.brlan.json5'),
        os.path.join('bg', 'ctrl', 'BlackBackObiInstructionText.brctr.json5'),
        os.path.join('bg', 'blyt', 'race_obi_bottom_message.brlyt.json5'),
        os.path.join('button', 'timg', 'checkmark-64.tpl'),
        os.path.join('button', 'ctrl', 'OptionsMenuLarge.brctr.json5'),
        os.path.join('button', 'blyt', 'LargeOptionsMenuButton.brlyt.json5'),
    ...
    os.path.join('Scene', 'UI', 'RaceSP.arc.lzma'): [
        ...
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_02_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w097_license_screen_menu_text_light_02_stop.brlan.json5'),
        #Only needed here, other archives have this in the right place
        os.path.join('button', 'ctrl', 'Back.brctr.json5'), 
        os.path.join('button', 'blyt', 'common_w008_back.brlyt.json5'),
        os.path.join('button', 'anim', 'common_w008_back_fade_in.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_fade_in_after.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_fade_in_before.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_fade_out.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_free_to_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_fuchi_check_loop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_select_to_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_text_light_01_ok.brlan.json5'),
        os.path.join('button', 'anim', 'common_w008_back_text_light_01_stop.brlan.json5'),
        ...
        os.path.join('button', 'blyt', 'common_w016_yajirushi_left.brlyt.json5'),
        os.path.join('button', 'blyt', 'common_w021_yajirushi_right.brlyt.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_chara_light_01_ok.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_chara_light_01_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_chara_light_02_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_chara_light_02_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_fade_in.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_fade_in_after.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_fade_in_before.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_fade_out.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_free_to_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_fuchi_check_loop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w016_yajirushi_left_select_to_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_chara_light_01_ok.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_chara_light_01_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_chara_light_02_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_chara_light_02_stop.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_fade_in.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_fade_in_after.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_fade_in_before.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_fade_out.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_free.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_free_to_select.brlan.json5'),
        os.path.join('button', 'anim', 'common_w021_yajirushi_right_fuchi_check_loop.brlan.json5'),
